...
var start = function (port, configure) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        var cancelTimer = setTimeout(function () { return reject("Server failed to start in 5 seconds"); }, 5000);
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        address: "http://localhost:".concat(address.port),
